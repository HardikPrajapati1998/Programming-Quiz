(function($){
  "use strict";
	...
	jQuery(document).ready(function($) { 
	  // Defualt Tab
 		jQuery('.lms_default_tab ul li:first').addClass('active');
		jQuery('.lms_default_ctab.tab-content div:first').addClass('active');
		// left Tab
		jQuery('.lms_left_tab ul li:first').addClass('active');
		jQuery('.lms_left_ctab.tab-content div:first').addClass('active');
		// right Tab
		jQuery('.lms_right_tab ul li:first').addClass('active');
		jQuery('.lms_right_ctab.tab-content div:first').addClass('active');
		var $this = $(window);
		// on load function
	...
	//$('#mainMenu > li').addClass('dropdown');
	$(document).ready(function(){
  $(".lms_edit_profile").click(function(){
    $("#lp-avatar-actions").toggleClass("lms_open_edit");
  });
});
	});
})(); 
